...
/**
 * Defines the access control handler for the sentinel key entity type.
 *
 * phpcs:disable Drupal.Arrays.Array.LongLineDeclaration
 *
 * @see https://www.drupal.org/project/coder/issues/3185082
 */
final class SentinelKeyAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL): AccessResult {
    return AccessResult::allowedIfHasPermissions($account, ['create sentinel_key', 'administer sentinel_key'], 'OR');
  }
